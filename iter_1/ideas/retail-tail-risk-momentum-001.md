...
- The more robust central default, rather than the top in-sample row, was 150-day trend / 189-day momentum / 126-day vol / 10% target vol / top 2 / 33% sleeve cap. It produced CAGR 10.33%, vol 6.88%, Sharpe 1.47, max drawdown -9.02%, Calmar 1.15, and 1% daily CVaR -1.74% before transaction costs.
- A transaction-cost sensitivity pass found roughly 333% annual one-way turnover. At 5 bps one-way cost, the same default still produced CAGR 10.15%, vol 6.88%, Sharpe 1.47, max drawdown -9.46%, and Calmar 1.07; even at 25 bps one-way cost it retained CAGR 9.42% and max drawdown -11.20%.
- Alternative-universe tests did not improve the conclusion: removing `DBC` reduced commodity roll concern but worsened CAGR and max drawdown; adding factor/sector ETFs increased complexity and turnover without a clearly superior reward-to-risk profile.
